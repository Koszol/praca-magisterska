function [PosX,PosY,PosZ] = model_cal3R(th1Val,th2Val,th3Val,len,errorB0,error01,error12,error23,error34)
    syms th1 th2 th3
%     th1_val=th1Val;
%     th2_val=th2Val;
    a1=0.1e3; 
    ...
    T23=mTr(th3+error23(1),error23(2),error23(3),error23(4),error23(5),error23(6));
