...
errorB0_rand=[zeros(PathSize,1),randVal(0.1,0.05,PathSize),zeros(PathSize,1),zeros(PathSize,1),randVal(0.5,0.1,PathSize),zeros(PathSize,1)];
error01_rand=[zeros(PathSize,1),zeros(PathSize,1),randVal(0.2,0.05,PathSize),zeros(PathSize,1),zeros(PathSize,1),zeros(PathSize,1)];
error12_rand=[randVal(0.2,0.03,PathSize),zeros(PathSize,1),zeros(PathSize,1),zeros(PathSize,1),zeros(PathSize,1),zeros(PathSize,1),];
tic
[test1,test2,test3]=path_2R(th1_path,th2_path,PathSize,errorB0_rand,error01_rand,error12_rand);
toc
